package lesson36stream.methods.example2;
...
public class MapExample {
    public static void main(String[] args) {
        ...
        Student student4 = new Student("Aygun", "female", 25, 5.2);
        ...
        List<Double> avgGradeList = studentList.stream()
                .map(element -> element.avrGrade - 1)
